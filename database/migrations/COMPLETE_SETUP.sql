-- COMPLETE DISCOUNT SYSTEM SETUP
-- Run this entire script in your Supabase SQL Editor

-- Step 1: Create the main discount system
...
-- Step 2: Add product-specific support
...
-- Step 7: Create usage tracking function
