...
import { adminProducts, adminCategories } from "../../../../utils/adminDummyData";
...
const ProductsPage = () => {
    ...
    const getStockColor = (quantity: number) => {
        if (quantity > 10) return 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200';
        if (quantity > 0) return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200';
                                    ...
                                    <tr key={product.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center gap-1 text-sm">
                                                ...
                                                <span className="text-gray-500 dark:text-gray-400">({product.review_count})</span>
                                            </div>
                                        </td>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                        ...
                        >
                            ...
                            <p className="text-gray-700 dark:text-gray-300 mb-6">
                                Are you sure you want to delete "{productToDelete.title}"? This will permanently remove the product from your catalog.
                            </p>
